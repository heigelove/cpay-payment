...
var doc = `{
    ...
    "info": {
        ...
        "license": {
            "name": "MIT",
            "url": "https://github.com/heigelove/cpay-payment/blob/master/LICENSE"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/agent.createResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/agent.detailResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/agent.modifyResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "agent.listResponse": {
            ...
            "properties": {
                "list": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/agent.listItem"
                    }
                }
            }
        },
        "agent.modifyResponse": {
            "type": "object",
            "properties": {
                "id": {
                    "description": "主键ID",
