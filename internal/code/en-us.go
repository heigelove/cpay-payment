...
var enUSText = map[int]string{
	...
	DailySummaryReportError: "Failed to generate daily summary report",

	WithdrawalCreateError:       "Failed to create withdrawal record",
	WithdrawalUpdateError:       "Failed to update withdrawal record",
	WithdrawalListError:         "Failed to get withdrawal record list",
	WithdrawalDeleteError:       "Failed to delete withdrawal record",
	WithdrawalDetailError:       "Failed to get withdrawal record detail",
	WithdrawalIdError:           "Withdrawal record ID error",
	WithdrawalStatisticsError:   "Failed to get withdrawal statistics",
	WithdrawalUpdateStatusError: "Failed to update withdrawal status",
	WithdrawalExportError:       "Failed to export withdrawal records",
	WithdrawalReviewError:       "Failed to review withdrawal application",

	// Settlement related error messages
	SettlementInvalidParams:  "Settlement parameters error",
	SettlementOrderNotFound:  "Settlement order not found",
	SettlementStatusInvalid:  "Order status not allowed for settlement",
	SettlementAlreadySettled: "Order already settled",
	SettlementDBOperation:    "Settlement database operation failed",

	// MerchantChannel related error messages
	MerchantChannelCreateError: "Failed to create merchant channel",
	MerchantChannelUpdateError: "Failed to update merchant channel",
	MerchantChannelDetailError: "Failed to get merchant channel details",
}
